package es.uma.lcc.caesium.pedestrian.evacuation.optimization.ma;
...
/**
 * Class for running the memetic evacuation optimization algorithm
 * @author ccottap
 * @version 1.0
 */
public class RunMAExitPlacement {
	/**
